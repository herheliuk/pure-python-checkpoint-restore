...
@dill_register(GeneratorType)
def reduce_generator(pickler, obj): # avoid PicklingError
    if __debug__:
        print(f"REDUCE {obj}")
    gen_func = obj.gi_frame.f_globals[obj.gi_code.co_name]
    args = ()
    pickler.save_reduce(gen_func, args, obj=obj)
